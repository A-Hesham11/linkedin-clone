...
import { registerUser, signInAPI } from '../redux/actions';
    ...
    <Container className='my-2'>
      <Nav className='navbar '>
        ...
        <div className='d-flex gap-2'>
            ...
            <Link to='/'>
                <button style={{height:'36px'}} className='sign btn border border-primary rounded-pill text-primary fw-bold fs-6 px-3 py-1'>Sign in</button>
            </Link>
        </div>
      </Nav>
      <div className='text-box d-flex align-items-center' style={{height:'80vh', justifyContent:'space-between', gap:'50px'}}>
        <div className='text-form w-50'>
            <h2 className='text-primary mb-4'>Get the most out of your career</h2>
            <Form onSubmit={handleSubmit}>
                ...
                <div className='text-center mt-4 text-gray-50'>
                    Already have a LinkedIn account? <Link to='/' className='fw-bold'>Login</Link>
                </div>
            </Form>
        </div>
